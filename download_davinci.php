	...
	<div class="container-fluid">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="page-header">
		        <h1 id="tab1">Brochure</h1>
		    </div>
		</div>
		<div class="container table-container brochure-container">
      <center><h1 class="brochure-title">da vinci</h1></center>
      <center>
      <!-- View Modal -->
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel"><h1 style="font-size: 20px; text-align: center; margin: 0px;">da vinci</h1></h4>
                              </div>
                              <div class="modal-body">
                                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                  <div class="carousel-inner">
                                    <div class="item active">
                                      <img src="assets/front-image/brochure.png"/>
                                    </div>
                                    <div class="item">

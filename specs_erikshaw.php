    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <ul class="navpills">
                    <li>
                      <a href="download_erikshaw.php"><!-- <img src="http://hulasmotors.com/demo/hulasmotors/assets-front/images/download.png"> --><h6>Brochure</h6></a>
                    </li>

                    <li>
                      <a href="specs_erikshaw.php"><!-- <img src="http://hulasmotors.com/demo/hulasmotors/assets-front/images/specs.png"> --><h6>Specs</h6></a>
                    </li>
                    <li>
		...
		<div class="col-md-12 col-xs-12 col-sm-12 specs-container">
                <div class="specs-row specs-row-top">
					...
					<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 specs-image">
						<img src="assets/back-image/products/re2.png" class="img-responsive">
					</div>
				</div>
         </div>
         <div class="col-md-12 col-xs-12 col-sm-12 specs-container model-name">
         	<div class="specs-row">
				...
				<div class="col-xs-4 col-sm-3 col-md-3 col-lg-3 specs-desc">
					<p>E-Rikshaw</p>	
				</div>
			</div>
         </div>

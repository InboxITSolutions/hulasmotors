...
<?php include 'partials/sub-nav.php'; ?>
	...
	<div class="container-fluid" style="padding: 0px;">
		...
		<div class="col-md-12 col-xs-12 col-sm-12 specs-container">
                <div class="specs-row specs-row-top">
					...
					<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 specs-image">
						<img src="assets/back-image/products/pic14.png" class="img-responsive">
					</div>
					<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 specs-image">
						<img src="assets/back-image/products/pic12.png" class="img-responsive">
					</div>
				</div>
         </div>
         <div class="col-md-12 col-xs-12 col-sm-12 specs-container model-name">
         	<div class="specs-row">
				...
				<div class="col-xs-4 col-sm-3 col-md-3 col-lg-3 specs-desc">
					<p>Hulas Big Cargo 1</p>	
				</div>
				<div class="col-xs-4 col-sm-3 col-md-3 col-lg-3 specs-desc">
					<p>Hulas Big Cargo 2</p>
				</div>
				<div class="col-xs-4 col-sm-3 col-md-3 col-lg-3 specs-desc">
					<p>Hulas Big Cargo 3</p>
				</div>
			</div>
         </div>
         <div class="col-md-12 col-xs-12 col-sm-12 specs-container">
